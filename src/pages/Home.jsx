...
// Importam reducerul asociat watchlistului, precum si state-ul initial.
...
export function Home() {
  //cerem  produse de la API si actualizam stateul
  ...
  useEffect(() => {
    fetch(
      'https://api.themoviedb.org/3/movie/upcoming?per_page=10&sort_by=popularity&api_key=fb5971af5b5f4e5a0fdd0b41d31d7b80'
    )
  ...
  return (
   ...
   {isAlertVisible && (
          <div
            className=" alert alert-secondary position-fixed top-10 start-50 translate-middle-x mt-2 fw-bold text-center z-3 px-3"
          ...
          {movies.map((movie) => {
            return (
              <Card
                ...
                className="custom-flex-card m-4"
              >
